...
ActiveRecord::Schema.define(:version => 20120811113154) do
  ...
  add_index "administradors", ["Users_id"], :name => "index_administradors_on_Users_id"
  ...
  add_index "doctors", ["Users_id"], :name => "index_doctors_on_Users_id"
